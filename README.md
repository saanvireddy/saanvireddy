...
<p align="center">
  <b>AI Engineer &nbsp;·&nbsp; Data Scientist &nbsp;·&nbsp; Data Engineer &nbsp;·&nbsp; Data Analyst</b><br/>
...
|--------|-------------|-------|
| [AI-Powered SQL Analytics Assistant](https://github.com/saanvireddy/ai-sql-assistant) | Production-ready NL-to-SQL engine — schema-aware prompting, SQL validation guardrails (SELECT-only, safe joins, LIMIT enforcement), Streamlit self-service UI | LangChain · Vertex AI (Gemini) · Python · SQL · Streamlit |
